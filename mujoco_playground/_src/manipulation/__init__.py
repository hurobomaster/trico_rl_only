...
from mujoco_playground._src.manipulation.trico import trico as trico_env
from mujoco_playground._src.manipulation.trico import trico_driver as trico_driver_env
